...
public class JSONArray extends ArrayList implements JSONAware, JSONStreamAware {
	...
	public JSONObject getObject(int index) {
		return JSONUtil.convertToJsonObject(get(index));
	}

	@Nullable
	public JSONArray getArray(int index) {
		return JSONUtil.convertToJsonArray(get(index));
	}

	@Nullable
	public String getString(int index) {
		return JSONUtil.convertToString(get(index));
	}

	@Nullable
	public Double getDouble(int index) {
		return JSONUtil.convertToDouble(get(index));
	}

	@Nullable
	public Long getLong(int index) {
		return JSONUtil.convertToLong(get(index));
	}
